                  ...
                  <form action="{{ url('addfriend') }}" method="GET">
                    @csrf
                      <div class="input-group input-group-lg">
                          <input type="search" class="form-control form-control-lg" name="pin" placeholder="Type your keywords here">
            ...
            <div class="col-md-10 offset-md-1">
                <div class="list-group">
                    <div class="list-group-item">
                        <div class="row">
                            <div class="col-auto">
                              <img class="profile-user-img img-fluid img-circle" src="{{ asset('image/220240226052530.jpeg') }}" alt="user image">
                          </div>
                          <div class="col px-4">
                              <div>
                                  <h3>{{ $add->name }}</h3>
